...
const SendPage = () => {
    ...
    const sendSearchVal =(e) => {
        ...
        axios.post("http://localhost:3002/findUsers", { searchVal: searchVal })//addAcc rouute will be used to craete an account with the sent information, after it was verified
        .then(response => {
